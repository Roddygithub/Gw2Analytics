...
// makeRow is aliased to buildPlayerReadoutRow for backward compat
// with existing test call-sites that import it as `makeRow`.
const makeRow = buildPlayerReadoutRow;
