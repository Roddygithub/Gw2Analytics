...
Backward compat: A.4 ships 4 entries (StunBreakEvent +
BarrierEvent + DeathEvent + DownEvent); unmapped
...
#:
#: v0.11.0 A.4: DEATH (byte 4) and DOWN (byte 5) shipped.
#: ConditionRemoveEvent remains deferred
