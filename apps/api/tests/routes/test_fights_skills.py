"""Route-level tests for GET /api/v1/fights/{id}/skills."""
...
def test_skills_200() -> None:
    """Valid fight returns skill usage rollup."""
...
def test_skills_404_unknown() -> None:
    """Unknown fight returns 404."""
    assert client.get("/api/v1/fights/nonexistent/skills").status_code == 404


def test_skills_404_no_events() -> None:
    ...
    assert client.get(f"/api/v1/fights/{fight_id}/skills").status_code == 404
