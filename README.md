...
⏭ **Phase 2** — FastAPI gate, Alembic, MinIO content-addressed blobs, V1.3 schema (`fights`, `fight_agents`, `fight_skills`), 37-test pytest suite, env-driven credentials via `pydantic-settings` + `pytest-env`.
