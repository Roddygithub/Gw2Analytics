...
5b. WIP branch `v0.10.21/f17-statechange-extension` ff-merged to main ONLY post M-8-bis close-out + pre-tag-force-advance. **F17 deferral gate:** if F17 phase 1 growth (see section 5 WIP lifecycle for "phase 1" definition) has NOT produced at least 1 commit on the WIP branch by step-5 execution time, F17 defers to v0.10.22 sub-cycle (NOT v0.10.21); WIP branch preserved; v0.10.21 cycle may STILL declare CLOSED if steps 1-4 PASS + D2/D1 baselines preserved.
